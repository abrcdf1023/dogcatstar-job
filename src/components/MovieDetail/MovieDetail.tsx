...
export const MovieDetail = (props: MovieDetailProps) => {
  ...
  return (
    <div
      className={cx("root")}
      style={{ backgroundImage: `url(${getImageUrl(movie?.backdrop_path || "", 1920, 800, "multi_faces")})` }}
    >
      <Container className={cx("container")}>
        ...
        <div className={cx("main")}>
          ...
          <Typography fontSize={12}>
            {movie?.release_date} {movie?.genres?.map((el) => el.name).join(", ")} {getHourMinutes(movie?.runtime || 0)}
          </Typography>
          ...
          <div className={cx("overview")}>
            ...
            <Typography fontSize={24} style={{ marginTop: 10, marginBottom: 8 }}>
              Overview
            </Typography>

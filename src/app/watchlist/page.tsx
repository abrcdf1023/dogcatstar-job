...
export default function Watchlist() {
  ...
  const sortedWatchlist = React.useMemo(() => {
    ...
    console.log('-----')
    if (sortBy === SORT_BY.DATE_ADDED) {
      return watchlist.sort((a, b) => isAsc ? a.timeAddedToWatch - b.timeAddedToWatch : b.timeAddedToWatch - a.timeAddedToWatch)
    }
  }, [sortBy, isAsc])
        ...
        <div className={cx('actions')}>
          <div className={cx('action')}>
            ...
            <select onChange={handleSortBy}>
              ...
              <option value={SORT_BY.UPCOMING}>Upcoming</option>
